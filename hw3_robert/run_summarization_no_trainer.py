...
def main():
    ...
    predict_ids = raw_datasets["validation"]['id']
    ...
    for step, batch in enumerate(tqdm(eval_dataloader)):
        with torch.no_grad():
            ...
            for pred in decoded_preds:
                predict_titles.append(pred)
    output_data = []
    for input_id, title in zip(predict_ids, predict_titles):
        output_data.append({'title': title, 'id': input_id})
        # print({'title': title, 'id': input_id})
    with jsonlines.open(str(args.output_path), mode='w') as writer:
