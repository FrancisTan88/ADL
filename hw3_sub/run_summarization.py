...
# python3 run_summarization.py --model_name_or_path google/mt5-small --train_file data/train.jsonl --validation_file data/public.jsonl --output_dir model_save --text_column maintext --summary_column title --per_device_train_batch_size=2 --per_device_eval_batch_size=2 --num_train_epochs 20 --learning_rate 1e-4 --gradient_accumulation_steps 8 --do_train --do_eval --predict_with_generate --overwrite_output_dir
